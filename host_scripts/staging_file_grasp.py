...
class GraspPlannerNode(Node):
    ...
    def _plan_top_down_grasp(self, obj_pos: Point, config: dict, 
        ...
        # Account for gripper finger thickness, length from wrist, and the surface offset
        grasp_pose.position.z = obj_pos.z + self._gripper_length + self._surface_offset
