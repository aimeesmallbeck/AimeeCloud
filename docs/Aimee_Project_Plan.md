...
### Phase 5: Cloud Integration (Week 6) ✅ MOSTLY COMPLETE
- [x] `brick_cloud_bridge` - AimeeCloud communication (MQTT)
- [x] `CloudIntent` message type
- [x] Cloud skill dispatcher in intent router
- [ ] Offline message queue (future)
- [ ] End-to-end testing with live AimeeCloud broker
...
- [x] Voice pipeline garbage filtering (`huh`, `um`, etc.)
- [x] Intent Router LLM deadlock fix + noise gate
