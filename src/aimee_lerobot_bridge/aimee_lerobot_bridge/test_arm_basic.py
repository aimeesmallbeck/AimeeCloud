...
# Positions in radians (firmware-native coordinates)
# elbow: 0=up, 1.57=horizontal forward, 3.14=down
# gripper: 0=fully open, 3.14=fully closed
HOME = [0.0, 0.0, 1.57, 0.0, 0.0, 3.14]          # gripper closed at home
ELBOW_DOWN = [0.0, 0.0, 0.78, 0.0, 0.0, 3.14]
BASE_RIGHT = [0.52, 0.0, 0.78, 0.0, 0.0, 3.14]
GRIPPER_OPEN = [0.52, 0.0, 0.78, 0.0, 0.0, 0.0]   # 0 = fully open
GRIPPER_CLOSE = [0.52, 0.0, 0.78, 0.0, 0.0, 3.14] # 3.14 = fully closed
