...
#include "aimee_msgs/msg/detail/led_action__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // led_id, pattern
#include "rosidl_runtime_c/string_functions.h"  // led_id, pattern

// forward declare type support functions


using _LEDAction__ros_msg_type = aimee_msgs__msg__LEDAction;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LEDAction__ros_msg_type * ros_message = static_cast<const _LEDAction__ros_msg_type *>(untyped_ros_message);
  // Field name: led_id
  {
    const rosidl_runtime_c__String * str = &ros_message->led_id;
  ...
  void * untyped_ros_message)
{
  ...
  _LEDAction__ros_msg_type * ros_message = static_cast<_LEDAction__ros_msg_type *>(untyped_ros_message);
  // Field name: led_id
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->led_id.data) {
      rosidl_runtime_c__String__init(&ros_message->led_id);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->led_id,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'led_id'\n");
      return false;
    }
  }
...
static uint32_t _LEDAction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aimee_msgs__msg__LEDAction(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aimee_msgs__msg__LEDAction;
    is_plain =
      (
...
static size_t _LEDAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aimee_msgs__msg__LEDAction(
...
static message_type_support_callbacks_t __callbacks_LEDAction = {
  "aimee_msgs::msg",
  "LEDAction",
