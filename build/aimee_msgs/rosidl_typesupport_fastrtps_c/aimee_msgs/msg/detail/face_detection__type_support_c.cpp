...
#include "aimee_msgs/msg/detail/face_detection__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // face_landmarks
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // face_landmarks
#include "rosidl_runtime_c/string.h"  // camera_source, face_id, person_name
#include "rosidl_runtime_c/string_functions.h"  // camera_source, face_id, person_name
...
using _FaceDetection__ros_msg_type = aimee_msgs__msg__FaceDetection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: face_id
  {
    const rosidl_runtime_c__String * str = &ros_message->face_id;
  ...
  // Field name: recognition_confidence
  {
  ...
  // Field name: num_faces_detected
  {
    cdr << ros_message->num_faces_detected;
  }

  // Field name: face_landmarks
  {
    size_t size = ros_message->face_landmarks.size;
    auto array_ptr = ros_message->face_landmarks.data;
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->camera_source;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: face_id
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->face_id.data) {
      rosidl_runtime_c__String__init(&ros_message->face_id);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->face_id,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'face_id'\n");
      return false;
    }
  }
  ...
  // Field name: face_landmarks
  {
    ...
    if (ros_message->face_landmarks.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->face_landmarks);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->face_landmarks, size)) {
      fprintf(stderr, "failed to create array for field 'face_landmarks'");
      return false;
    }
    auto array_ptr = ros_message->face_landmarks.data;
  ...
  // Field name: camera_source
  {
    ...
    if (!ros_message->camera_source.data) {
      rosidl_runtime_c__String__init(&ros_message->camera_source);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->camera_source,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'camera_source'\n");
      return false;
    }
  }
...
size_t get_serialized_size_aimee_msgs__msg__FaceDetection(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FaceDetection__ros_msg_type * ros_message = static_cast<const _FaceDetection__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FaceDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aimee_msgs__msg__FaceDetection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aimee_msgs
size_t max_serialized_size_aimee_msgs__msg__FaceDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aimee_msgs__msg__FaceDetection;
    is_plain =
      (
...
static size_t _FaceDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aimee_msgs__msg__FaceDetection(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aimee_msgs, msg, FaceDetection)() {
