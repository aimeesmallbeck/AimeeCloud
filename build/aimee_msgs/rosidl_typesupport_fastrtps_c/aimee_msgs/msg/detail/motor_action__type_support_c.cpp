...
#include "aimee_msgs/msg/detail/motor_action__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // action_type, motor_id
#include "rosidl_runtime_c/string_functions.h"  // action_type, motor_id
...
using _MotorAction__ros_msg_type = aimee_msgs__msg__MotorAction;

static bool _MotorAction__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorAction__ros_msg_type * ros_message = static_cast<const _MotorAction__ros_msg_type *>(untyped_ros_message);
  // Field name: motor_id
  {
...
static bool _MotorAction__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MotorAction__ros_msg_type * ros_message = static_cast<_MotorAction__ros_msg_type *>(untyped_ros_message);
  // Field name: motor_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _MotorAction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aimee_msgs__msg__MotorAction(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aimee_msgs__msg__MotorAction;
    is_plain =
      (
...
static size_t _MotorAction__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_aimee_msgs__msg__MotorAction(
...
static message_type_support_callbacks_t __callbacks_MotorAction = {
  "aimee_msgs::msg",
  "MotorAction",
  _MotorAction__cdr_serialize,
  _MotorAction__cdr_deserialize,
  _MotorAction__get_serialized_size,
  _MotorAction__max_serialized_size
};

static rosidl_message_type_support_t _MotorAction__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorAction,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aimee_msgs, msg, MotorAction)() {
  return &_MotorAction__type_support;
}
