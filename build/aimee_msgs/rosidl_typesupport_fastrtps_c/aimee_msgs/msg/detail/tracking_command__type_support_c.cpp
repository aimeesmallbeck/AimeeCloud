...
#include "aimee_msgs/msg/detail/tracking_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // command, mode, target_id, target_type
#include "rosidl_runtime_c/string_functions.h"  // command, mode, target_id, target_type
...
using _TrackingCommand__ros_msg_type = aimee_msgs__msg__TrackingCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackingCommand__ros_msg_type * ros_message = static_cast<const _TrackingCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: command
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrackingCommand__ros_msg_type * ros_message = static_cast<_TrackingCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: command
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _TrackingCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aimee_msgs__msg__TrackingCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aimee_msgs__msg__TrackingCommand;
    is_plain =
      (
...
static size_t _TrackingCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aimee_msgs__msg__TrackingCommand(
...
static message_type_support_callbacks_t __callbacks_TrackingCommand = {
  "aimee_msgs::msg",
  "TrackingCommand",
...
static rosidl_message_type_support_t _TrackingCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackingCommand,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aimee_msgs, msg, TrackingCommand)() {
  return &_TrackingCommand__type_support;
}
