...
#include "aimee_msgs/msg/detail/wake_word_detection__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // session_id, source, wake_word
#include "rosidl_runtime_c/string_functions.h"  // session_id, source, wake_word
...
using _WakeWordDetection__ros_msg_type = aimee_msgs__msg__WakeWordDetection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WakeWordDetection__ros_msg_type * ros_message = static_cast<const _WakeWordDetection__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: sample_index
  {
    cdr << ros_message->sample_index;
  }

  // Field name: signal_energy
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WakeWordDetection__ros_msg_type * ros_message = static_cast<_WakeWordDetection__ros_msg_type *>(untyped_ros_message);
  // Field name: wake_word
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_aimee_msgs__msg__WakeWordDetection(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WakeWordDetection__ros_msg_type * ros_message = static_cast<const _WakeWordDetection__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _WakeWordDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aimee_msgs__msg__WakeWordDetection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aimee_msgs
size_t max_serialized_size_aimee_msgs__msg__WakeWordDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aimee_msgs__msg__WakeWordDetection;
    is_plain =
      (
...
static size_t _WakeWordDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aimee_msgs__msg__WakeWordDetection(
...
static message_type_support_callbacks_t __callbacks_WakeWordDetection = {
  "aimee_msgs::msg",
  "WakeWordDetection",
...
static rosidl_message_type_support_t _WakeWordDetection__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WakeWordDetection,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aimee_msgs, msg, WakeWordDetection)() {
  return &_WakeWordDetection__type_support;
}
