...
bool aimee_msgs__msg__motor_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimee_msgs.msg._motor_action.MotorAction", full_classname_dest, 40) == 0);
  }
  aimee_msgs__msg__MotorAction * ros_message = _ros_message;
  {  // motor_id
...
{
  /* NOTE(esteve): Call constructor of MotorAction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimee_msgs.msg._motor_action");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorAction");
