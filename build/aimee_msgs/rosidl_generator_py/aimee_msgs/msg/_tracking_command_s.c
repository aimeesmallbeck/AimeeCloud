...
bool aimee_msgs__msg__tracking_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimee_msgs.msg._tracking_command.TrackingCommand", full_classname_dest, 48) == 0);
  }
  aimee_msgs__msg__TrackingCommand * ros_message = _ros_message;
  {  // command
  ...
  {  // preset_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "preset_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->preset_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // zoom_level
    PyObject * field = PyObject_GetAttrString(_pymsg, "zoom_level");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->zoom_level = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // target_type
...
{
  /* NOTE(esteve): Call constructor of TrackingCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimee_msgs.msg._tracking_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackingCommand");
  ...
  {  // preset_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->preset_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "preset_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // zoom_level
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->zoom_level);
    {
      int rc = PyObject_SetAttrString(_pymessage, "zoom_level", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
