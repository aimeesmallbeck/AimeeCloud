...
static const _MotorAction_type_support_symbol_names_t _MotorAction_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aimee_msgs, msg, MotorAction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aimee_msgs, msg, MotorAction)),
  }
};
...
{
  return &::aimee_msgs::msg::rosidl_typesupport_cpp::MotorAction_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aimee_msgs, msg, MotorAction)() {
  return get_message_type_support_handle<aimee_msgs::msg::MotorAction>();
}
