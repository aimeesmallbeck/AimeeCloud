...
#include "aimee_msgs/msg/detail/camera_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aimee_msgs::msg::CameraAction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aimee_msgs::msg::CameraAction & ros_message)
{
  // Member: action_type
  cdr >> ros_message.action_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aimee_msgs::msg::CameraAction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aimee_msgs::msg::CameraAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aimee_msgs::msg::CameraAction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CameraAction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aimee_msgs::msg::CameraAction *>(
...
static size_t _CameraAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CameraAction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CameraAction__callbacks = {
  "aimee_msgs::msg",
  "CameraAction",
...
static rosidl_message_type_support_t _CameraAction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CameraAction__callbacks,
...
{
  return &aimee_msgs::msg::typesupport_fastrtps_cpp::_CameraAction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aimee_msgs, msg, CameraAction)() {
  return &aimee_msgs::msg::typesupport_fastrtps_cpp::_CameraAction__handle;
}
